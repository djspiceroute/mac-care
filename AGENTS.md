...
> **Local extensions:** If `AGENTS.local.md` exists in this directory, read it after this file.
> It is gitignored and holds machine-local tooling instructions (e.g. GitNexus code intelligence).
...
This project is indexed by GitNexus as **mac-care** (465 symbols, 731 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
